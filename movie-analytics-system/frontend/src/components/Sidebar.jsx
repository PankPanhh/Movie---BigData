...
const NavItem = ({ to, icon, label }) => (
  ...
  >
    {/* Icon SVG */}
    <div className="w-6 h-6 mr-3" dangerouslySetInnerHTML={{ __html: icon }} />
...
const icons = {
  ...
  analytics: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C21.496 3 22 3.504 22 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>`,
};
  ...
  return (
    <aside className="w-64 bg-white shadow-xl flex-shrink-0 flex flex-col">
      ...
      <div className="p-6 flex items-center space-x-3">
        ...
        >
          <path
            ...
            d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 3.124L18 12M6 12v3.75c0 .621.504 1.125 1.125 1.125H16.875A1.125 1.125 0 0 0 18 15.75V12M6 12v-3.75c0-.621.504-1.125 1.125-1.125H16.875A1.125 1.125 0 0 1 18 8.25V12"
          />
        </svg>
        <div>
      ...
      <nav className="p-4 space-y-2 flex-1">
        ...
        <NavItem to="/analytics" icon={icons.analytics} label="Analytics" />
        ...
        <NavItem to="/debug" icon={icons.dashboard} label="Debug / Index" />
      </nav>
    </aside>
  );
}
